...
variable "diagnostic_setting" {
  ...
  type = map(
    object({
      log_type             = optional(list(string))
      log_analytics_workspace_id = optional(string)
      metric_type          = optional(list(string))
      log_metric_retention = optional(number)
...
variable "private_ip_address_allocation" {
  description = "(Optional) Private IP address allocation."
  type        = string
  default     = "Dynamic"
}
...
variable "recovery_vault_name" {
  description = "(Optional) Specifies the name of the Recovery Services Vault to use. Changing this forces a new resource to be created"
  type        = string
  default     = ""
}
variable "backup_policy_id" {
  description = "(Optional) Specifies the id of the backup policy to use"
  type        = string
  default     = ""
}

variable "backup_vault_resource_group_name" {
  description = "(Optional) The name of the resource group in which to create the Recovery Services Vault. Changing this forces a new resource to be created"
  type        = string
  default     = ""
}